...
public class PageReaderTemperature extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_reader_temperature);
		...
		mTemperatureEditText = (EditText) findViewById(R.id.temperature_text);
