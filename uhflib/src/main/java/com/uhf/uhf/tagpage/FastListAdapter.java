...
public class FastListAdapter extends BaseAdapter {
	...
	public FastListAdapter(Context context, List<InventoryBuffer.InventoryTagMap> listMap) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.tag_fast_list_item, null);
		...
		listItemView.mTimesText.setText(
				String.valueOf(map.nAnt1) + "  /  " + 
				String.valueOf(map.nAnt2) + "  /  " + 
				String.valueOf(map.nAnt3) + "  /  " + 
				String.valueOf(map.nAnt4));
